...
interface MasterPoint { id: number; code: string; name: string; location: string | null; pipelineId: number | null; pipeline?: { code: string; name: string } | null; blindState?: string | null; blindLabel?: string | null }
